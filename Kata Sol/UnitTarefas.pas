...
type
  TFormTarefas = class(TForm)
    ...
    LayoutGroupTarefas: TdxLayoutGroup;
    ...
    LayoutItemChAgendada: TdxLayoutItem;
    LayoutItemChAdiada: TdxLayoutItem;
    LayoutItemChFinalizada: TdxLayoutItem;
    LayoutItemChAtrasada: TdxLayoutItem;
    LayoutItemBtPesquisar: TdxLayoutItem;
    LayoutGroupCampoTarefas: TdxLayoutGroup;
